...
*/
	...
	Videos= [
	  ...
	  {id: 'Cantus', src: 'video/Cantus.mp4', part:'Cantus'},
		...
		Parts = [
			{id: 'CantusPart', src: 'video/cantusPart.mov', part:'Cantus'},
			{id: 'AltusPart', src: 'video/altusPart.mov', part:'Altus'},
			{id: 'TenorPart', src: 'video/tenorPart.mov', part:'Tenor'},
			{id: 'BassusPart' , src: 'video/bassusPart.mov', part:'Bassus' },
