...
*/
  ...
  prefix = 'pieces/zirlerMotet/'
	Videos= [

	  {id: 'Cantus', src: prefix+'videos/Cantus.mp4', part:'Cantus'},
		{id: 'Altus', src: prefix+'videos/Altus.mp4', part:'Altus'},
		{id: 'Tenor', src: prefix+'videos/Tenor.mp4', part:'Tenor'},
		{id: 'Bassus' , src: prefix+'videos/Bassus.mp4', part:'Bassus' },
		{id: 'Master', src: prefix+'videos/Master.mp4', part:'All' }

    ];

		Parts = [
			{id: 'CantusPart', src: prefix+'videos/cantusPart.mov', part:'Cantus'},
			{id: 'AltusPart', src: prefix+'videos/altusPart.mov', part:'Altus'},
			{id: 'TenorPart', src: prefix+'videos/tenorPart.mov', part:'Tenor'},
			{id: 'BassusPart' , src: prefix+'videos/bassusPart.mov', part:'Bassus' },
			{id: 'AllParts', src: prefix+'videos/fullscore.mov', part:'All' }
		];
